...
export declare const renderDottedLine: (x1: number, y1: number, x2: number, y2: number, r: number, interval: number, context: CanvasRenderingContext2D, color: string, offset: number) => void;
