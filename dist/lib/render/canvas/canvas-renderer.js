...
var CanvasRenderer = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                paths.forEach(function (point, index) {
                    ...
                    var diff = _this.ctx.lineWidth / 2;
                    if (side === 0) {
                        if (index === 0) {
                            start.y += diff;
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        border = borders_1[_i];
                        if (!(border.style !== border_style_1.BORDER_STYLE.NONE && !color_1.isTransparent(border.color))) return [3 /*break*/, 11];
    ...
    CanvasRenderer.prototype.renderDottedBorder = function (color, side, curvePoints) {
        return __awaiter(this, void 0, void 0, function () {
            var paths, data, r, width, dotAndSpace, dotCount, space, x1, y1, x2, y2, interval, offset;
            return __generator(this, function (_a) {
                paths = border_1.parsePathForBorder(curvePoints, side);
                data = border_1.parseWidthForDashedAndDottedBorder(paths, side);
                r = data.space / 2;
                width = data.width;
                dotAndSpace = data.space * 2;
                dotCount = Math.floor(width / dotAndSpace);
                space = (width - data.space * dotCount) / (dotCount - 1);
                if (space > data.space * 1.5) {
                    space = (width - data.space * (dotCount + 1)) / dotCount;
                }
                x1 = data['startPos']['x'];
                y1 = data['startPos']['y'];
                interval = side > 1 ? -space : space;
                offset = 0;
                if (side === 0) {
                    y2 = y1;
                    x2 = x1 + width;
                ...
                border_1.renderDottedLine(x1, y1, x2, y2, r, interval, this.ctx, color_1.asString(color), offset);
                return [2 /*return*/];
            });
        });
    };
    CanvasRenderer.prototype.renderDashedBorder = function (color, side, curvePoints) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                dashAndSpace = dash + (data.space < 3 ? data.space * 3 : data.space);
                dashCount = Math.floor(width / dashAndSpace);
                space = (width - dash * dashCount) / (dashCount - 1);
                if (space > dash * 0.5) {
