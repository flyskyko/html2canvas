...
var renderDottedLine = function (x1, y1, x2, y2, r, interval, context, color, offset) {
    if (!interval) {
        interval = 5;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        border = borders_1[_i];
                        if (!(border.style !== BORDER_STYLE.NONE && !isTransparent(border.color))) return [3 /*break*/, 11];
